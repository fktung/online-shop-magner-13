...
export const MenuMobileBottom = () => {
  ...
  return (
    <div className="fixed sm:hidden z-20 py-4 grid w-full grid-cols-5 bg-white bottom-0 rounded-t-3xl drop-shadow-[0_-3px_6px_rgba(0,0,0,0.25)] place-items-center">
