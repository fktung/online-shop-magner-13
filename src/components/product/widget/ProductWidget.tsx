...
export const ProductWidget = ({ data, className }: IProductWidgetProps) => {
  ...
  return (
    <div
      className={`w-full p-4 mx-1 my-4 relative rounded-lg shadow-md cursor-pointer sm:mx-2 dark:shadow-brand-muted slider-card ${className}`}
    >
      ...
      <div className="flex flex-row-reverse items-center justify-between text-xs">
        {data.sold_amount && <p>{FormatNumber(+data.sold_amount)} Terjual</p>}
